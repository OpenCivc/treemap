...
for s in treemap.species.SPECIES:
  ...
  cursor.execute("INSERT INTO treemap_species (instance_id, max_diameter, max_height, udfs, genus, species, cultivar, common_name, otm_code) VALUES (1, 200, 800, '', %s, %s, %s, %s, %s)", [s['genus'], s['species'], s['cultivar'], s['common_name'], s['otm_code']])
...
for tree in trees['features']:
  ...
  if tp['species_id'] is not None:
    ...
    try:
      ...
      try:
        cursor.execute("INSERT INTO treemap_species (instance_id, max_diameter, max_height, udfs, genus, common_name, otm_code) VALUES (1, 200, 800, '', %s, %s, %s)", [tp['scientific_name'], tp['common_name'], tp['species_id']])
  ...
  t = Tree(id=tp['id'], diameter=tp['dbh'], height=tp['height'], canopy_height=tp['canopy_height'], date_planted=date_planted, date_removed=date_removed, plot=plot, instance=city, species=species)
